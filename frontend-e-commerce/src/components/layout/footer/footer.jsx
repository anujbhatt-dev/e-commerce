     ...
     return (
       <>
            ...
            <footer className="footer">
                   <Link data-aos="fade-down" to="/sizeChart">size chart</Link>
                   <Link data-aos="fade-down" to="/privacyPolicy">privacy policy</Link>
                   <Link data-aos="fade-down" to="/deliveryAndReturn">dilevery and returns</Link>
                   <span data-aos="fade-down" className="nav__list--item">contact us
                   ...
                   <Link data-aos="fade-down" to="/whoAreWe">who are we</Link>
